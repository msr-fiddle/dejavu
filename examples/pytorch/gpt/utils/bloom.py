...
from . import gpt_dv
from . import parallel_gpt_dv


class BloomWeight(gpt_dv.GPTWeights):
...
class Bloom(parallel_gpt_dv.ParallelGPT):

    def __init__(self,
                 head_num, size_per_head,
                 vocab_size, start_id, end_id, layer_num, ckpt_path, max_seq_len,
                 ...
                 restart: bool = False):
        super().__init__(
            head_num, size_per_head, vocab_size, start_id, end_id, layer_num, ckpt_path,
